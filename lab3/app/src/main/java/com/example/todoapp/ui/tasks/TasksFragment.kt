...
class TasksFragment : Fragment(R.layout.fragment_tasks), TasksAdapter.OnItemClickListener {
    ...
    override fun onCreateOptionsMenu(menu: Menu, inflater: MenuInflater) {
        ...
        viewLifecycleOwner.lifecycleScope.launch {
            menu.findItem(R.id.action_hide_completed_tasts).isChecked =
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        return when (item.itemId) {
            ...
            R.id.action_sort_by_category -> {
                viewModel.onSortOrderSelected(SortOrder.BY_CATEGORY)
                true
            }

            R.id.action_sort_by_exec_time -> {
                viewModel.onSortOrderSelected(
                    SortOrder.BY_COMPLETED_TIME
                )
                true
            }

            R.id.action_hide_completed_tasts -> {
